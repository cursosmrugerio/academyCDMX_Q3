...
.DESCRIPTION
  Hace con cada servidor lo mismo que hará VS Code cuando lo arranque, pero desde la terminal:
    ...
    3. Servidores "http" (el mcp.json del curso no trae ninguno; sirve si agregas uno remoto): manda
       "initialize" y "tools/list" a la URL.
...
.EXAMPLE
  ...
  pwsh -NoProfile -File $HOME\academyCDMX_Q3\copilot\dia-5\comprobar-mcp.ps1
#>
param(
