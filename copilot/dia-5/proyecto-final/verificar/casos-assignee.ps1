...
<#
.SYNOPSIS
  Casos REST de PATCH /tasks/{id}/assignee para el script del viernes, verificar.ps1.
...
.DESCRIPTION
  ...
  verificar.ps1, después de que las comprobaciones del viernes ya revisaron /tasks/unassigned con la semilla intacta.
