...
Material del proyecto final del sábado 17 de octubre. La guía que lo recorre paso a paso es la
del sábado (§8 · PF-1 a PF-7); esta carpeta solo tiene los archivos que copias. `verificar.ps1` en Windows, con
lo del miércoles al viernes completo: 14/14, 16/16 y 12/12.
...
| `verificar/` | Los casos REST de cada feature para el script del viernes: `casos-search.ps1`, `casos-assignee.ps1`, `casos-progress.ps1` | `.github/skills/verificar-taskflow/casos-<feature>.ps1` |
