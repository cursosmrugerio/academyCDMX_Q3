...
public class TaskController {
    ...
    /** GET /tasks/overdue — tareas vencidas de todos los proyectos, la más vencida primero. */
    ...
    /** GET /tasks/unassigned — tareas sin responsable, por dueDate ascendente y sin fecha al final. */
