...
public class TaskService {
    ...
    /**
     * Tareas vencidas de todos los proyectos (GET /tasks/overdue, S6, copilot/dia-2). La regla es la del
     ...
     * copilot/dia-2). La regla es ReportService.SIN_ASIGNAR; el orden, TaskOrders.POR_FECHA: por fecha
