...
.EXAMPLE
  ...
  & $HOME\academyCDMX_Q3\copilot\dia-1\verificar-arquitectura.ps1

.EXAMPLE
  & $HOME\academyCDMX_Q3\copilot\dia-1\verificar-arquitectura.ps1 | Tee-Object evidencia\dia1\verificador.txt
#>
param(
