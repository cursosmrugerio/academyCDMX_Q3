-- escenario-tareas.sql — ESCENARIO DECLARATIVO para @DataJpaTest.
--
...
-- dentro de ESE test.
--
-- ALCANCE DE LOS IDS: los ids fijos de abajo (proyectos 1-2, tareas 1-8) SOLO valen
-- DENTRO del test que carga este script. Asumirlos en OTRA clase de test = acoplarse a datos ajenos
-- (la regla de independencia de los tests, en versión SQL). Aquí valen porque el esquema nace limpio.
--
...
INSERT INTO projects (id, name, description, owner_id, created_at) VALUES
    (1, 'Plataforma TaskFlow', 'El backend REST de TaskFlow', 1, DATE '2024-01-01'),
